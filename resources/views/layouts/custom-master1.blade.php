...
<html lang="en"  dir="ltr" data-nav-layout="vertical" data-theme-mode="light" data-header-styles="light" data-menu-styles="dark">
    ...
    <head>
        ...
        <meta name="description" content="fairfirst insurance">
        <meta name="author" content="fairfirst insurance">
        <meta name="keywords" content="fairfirst insurance">
        <meta name="csrf-token" content="{{ csrf_token() }}">
        <!-- TITLE -->
        <title>FAIRFIRST INSURANCE</title>
