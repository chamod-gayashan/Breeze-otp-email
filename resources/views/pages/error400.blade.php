                ...
                <div class="container text-center">
                    <div class="error-template">
                        ...
                        <div class="text-center">
                            <a class="btn btn-secondary mt-5" href="{{url('home')}}"> <i class="fa fa-long-arrow-left"></i> Back to Home </a>
                        </div>
                    </div>
                </div>
            </div>
